...
JsonSchemaFormService.ɵprov = ɵɵdefineInjectable({ factory: function JsonSchemaFormService_Factory() { return new JsonSchemaFormService(); }, token: JsonSchemaFormService, providedIn: "root" });
...
WidgetLibraryService.ɵprov = ɵɵdefineInjectable({ factory: function WidgetLibraryService_Factory() { return new WidgetLibraryService(); }, token: WidgetLibraryService, providedIn: "root" });
...
FrameworkLibraryService.ɵprov = ɵɵdefineInjectable({ factory: function FrameworkLibraryService_Factory() { return new FrameworkLibraryService(ɵɵinject(Framework), ɵɵinject(WidgetLibraryService)); }, token: FrameworkLibraryService, providedIn: "root" });
